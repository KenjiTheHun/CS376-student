...
public class Player : MonoBehaviour
{
    ...
    /// <summary>
    /// The rigid body that we will move and rotate
    /// </summary>
    ...
    private void FireOrb()
    {
        ...
        orb.GetComponent<Rigidbody2D>().velocity = transform.right * OrbVelocity;
    }
    ...
    /// <summary>
    /// Get the rigid body so we can move and rotate
    /// </summary>
    void Start()
    {
